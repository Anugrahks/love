...
const useInternetIdentity = () => {
  return { identity: null, login: async () => {
  }, logout: async () => {
  } };
};
...
function LandingScreen({ onStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-6 max-w-2xl fade-in-slow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 inline-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-20 h-20 text-primary animate-pulse", fill: "currentColor" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-script text-rose-500 drop-shadow-lg animate-fade-in-up delay-200", children: "Kukku…" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl lg:text-3xl mb-12 text-foreground/80", children: "I made something just for you 💌" }),
...
function AmbientBackground() {
  ...
  reactExports.useEffect(() => {
    ...
    const drawPetal = (ctx2, x2, y, size, rotation, opacity) => {
      ctx2.save();
      ctx2.translate(x2, y);
      ...
      ctx2.beginPath();
      ctx2.moveTo(0, -size);
      ctx2.bezierCurveTo(size * 0.5, -size * 0.8, size * 0.8, -size * 0.3, size * 0.3, 0);
      ctx2.bezierCurveTo(size * 0.5, size * 0.3, 0, size * 0.5, 0, 0);
      ctx2.bezierCurveTo(0, size * 0.5, -size * 0.5, size * 0.3, -size * 0.3, 0);
      ctx2.bezierCurveTo(-size * 0.8, -size * 0.3, -size * 0.5, -size * 0.8, 0, -size);
      const gradient = ctx2.createRadialGradient(0, 0, 0, 0, 0, size);
    ...
    const drawHeart = (ctx2, x2, y, size, opacity) => {
      ctx2.save();
      ctx2.translate(x2, y);
      ctx2.globalAlpha = opacity;
      ctx2.beginPath();
      ctx2.moveTo(0, size * 0.3);
      ctx2.bezierCurveTo(-size * 0.5, -size * 0.2, -size, -size * 0.2, -size, size * 0.2);
      ctx2.bezierCurveTo(-size, size * 0.5, -size * 0.5, size * 0.7, 0, size);
      ctx2.bezierCurveTo(size * 0.5, size * 0.7, size, size * 0.5, size, size * 0.2);
      ctx2.bezierCurveTo(size, -size * 0.2, size * 0.5, -size * 0.2, 0, size * 0.3);
      const gradient = ctx2.createRadialGradient(0, 0, 0, 0, 0, size);
      ...
      ctx2.fill();
      ctx2.shadowBlur = 15;
      ctx2.shadowColor = "rgba(255, 105, 180, 0.5)";
      ctx2.fill();
      ctx2.restore();
    };
    let animationId;
...
const useCustomizationStore = create()(
  persist(
    (set, get) => ({
      ...
      setTimelineEntry: (index2, note, photo) => set((state) => {
        const newTimeline = [...state.timelineEntries];
        newTimeline[index2] = {
          ...newTimeline[index2],
          note,
          photo: photo || newTimeline[index2].photo
        };
        return { timelineEntries: newTimeline };
      }),
      setFlipCardMessage: (index2, message) => set((state) => {
        const newMessages = [...state.flipCardMessages];
        newMessages[index2] = { ...newMessages[index2], message };
        ...
        try {
          ...
          set((state) => ({
            ...
            timelineEntries: state.timelineEntries.map((entry, i) => {
              ...
              return {
                ...entry,
                note: ((_b2 = (_a2 = parsed.timelineEntries) == null ? void 0 : _a2[i]) == null ? void 0 : _b2.note) || entry.note
              };
            }),
            flipCardMessages: parsed.flipCardMessages ? state.flipCardMessages.map((msg, i) => ({
              ...msg,
...
function AudioController({ shouldStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Button,
    {
      ...
      children: isMuted ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-5 h-5" })
    }
  );
}
...
function useRevealOnScroll(ref, threshold = 0.1) {
...
function GlassCard({ children, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("glass-card rounded-3xl", className), children });
}
function OurStoryTimeline() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-20 px-4 md:px-8 max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-gradient-romantic", children: "Our Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground", children: "Every moment with you is a chapter I never want to end" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-primary opacity-30 hidden md:block" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12 md:space-y-20", children: timelineEntries.map((entry, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        TimelineEntry,
        {
          entry,
          index: index2,
          isEven: index2 % 2 === 0,
          onNoteChange: (note) => setTimelineEntry(index2, note, entry.photo)
        },
        index2
      )) })
    ] })
...
function TimelineEntry({ entry, index: index2, isEven, onNoteChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-1/2 w-4 h-4 bg-primary rounded-full border-4 border-background transform -translate-x-1/2 hidden md:block glow-soft" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${isEven ? "md:col-start-1" : "md:col-start-2"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-6 md:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl md:text-3xl font-bold mb-4 text-gradient-romantic", children: entry.title }),
          entry.photo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 rounded-2xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: entry.photo,
              alt: entry.title,
...
function ReasonsFlipCards() {
  const flipCardMessages = useCustomizationStore((state) => state.flipCardMessages);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-20 px-4 md:px-8 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-gradient-romantic", children: "12 Reasons I'm Crazy About You" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground", children: "Tap each card to reveal why you're everything to me" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6", children: flipCardMessages && flipCardMessages.map((entry, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      FlipCard,
      {
        index: index2 + 1,
        entry,
...
function FlipCard({ index: index2, entry, isSpecial }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flip-card-inner", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flip-card-front", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          GlassCard,
          {
            className: `w-full h-full flex flex-col items-center justify-center p-6 ${isSpecial ? "glow-gold" : "hover:glow-soft"} transition-all duration-300 overflow-hidden relative`,
            children: [
              entry.photo ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: entry.photo,
                  alt: `Reason ${index2}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-6xl font-bold ${isSpecial ? "text-gradient-gold" : "text-primary"}`, children: index2 })
              ] }),
              entry.photo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-start justify-center bg-black/30 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-6xl font-bold text-white drop-shadow-lg", children: index2 }) })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flip-card-back", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          GlassCard,
          {
            className: `w-full h-full flex items-center justify-center p-6 text-center ${isSpecial ? "glow-gold" : ""}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-lg md:text-xl font-medium ${isSpecial ? "text-gradient-gold text-2xl" : ""}`, children: isSpecial ? `And I'm never letting you go ❤️` : entry.message })
          }
        ) })
      ] })
    }
...
function LoveLetter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4 md:px-8 max-w-4xl mx-auto text-center fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-8 md:p-12 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-transparent via-pink-500 to-transparent opacity-50" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-8 text-gradient-romantic font-serif", children: "My dear Kukku," }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed font-serif text-left md:text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "I’ve been thinking a lot about us… and about the way I’ve hurt you. I want to say this clearly and sincerely — ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: "I am truly sorry." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I’m sorry for the fights, for raising my voice, for making you cry, and for ruining your mood — even when you were just trying to enjoy your time with your friends. Especially after our last fight… I feel really bad about it. You didn’t deserve that from someone who loves you." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Sometimes my anger speaks faster than my heart, and I end up saying things I never actually mean. But that is not an excuse. I regret every word that hurt you. I hate knowing I was the reason for your tears." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I promise I’m going to change — not just by saying it, but by showing it. I don’t want to fight you anymore. I want to understand you, protect your happiness, and be the reason you smile… not cry." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 text-2xl md:text-3xl font-handwriting text-gradient-gold", children: "Always yours ❤️" })
  ] }) });
}
...
function LoveMeter() {
  ...
  const [isBroken, setIsBroken] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref, className: "relative py-20 px-4 md:px-8 max-w-4xl mx-auto", children: [
    showConfetti && /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiAnimation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-gradient-romantic", children: "The Love Meter" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground", children: "Measuring how much I love you..." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { className: "p-8 md:p-12", children: !isBroken ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-6xl md:text-8xl font-bold text-gradient-romantic", children: [
        progress,
        "%"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: progress, className: "h-8 md:h-12" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6 animate-pulse", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl md:text-6xl font-bold text-destructive", children: "⚠️ SYSTEM ERROR ⚠️" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl md:text-3xl font-bold text-gradient-romantic", children: "Love too powerful to measure 💞" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg md:text-xl text-muted-foreground", children: "The meter couldn't handle how much I love you" })
    ] }) })
  ] });
}
...
function ValentinesCountdown() {
  ...
  reactExports.useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      if (now2 > valentinesDay) {
        valentinesDay = new Date(currentYear + 1, 1, 14);
      }
      const difference = valentinesDay.getTime() - now2.getTime();
      if (difference > 0) {
        setTimeLeft({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-6 md:p-8 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl md:text-2xl font-bold mb-4 text-gradient-romantic", children: "Countdown to Next Valentine's Day" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-bold text-primary", children: timeLeft.days }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Days" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-bold text-primary", children: timeLeft.hours }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Hours" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-bold text-primary", children: timeLeft.minutes }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Minutes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-bold text-primary", children: timeLeft.seconds }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Seconds" })
      ] })
    ] })
  ] });
}
function FloatingLoveFooter() {
  const appIdentifier = typeof window !== "undefined" ? encodeURIComponent(window.location.hostname || "valentine-love-story") : "valentine-love-story";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg md:text-xl text-foreground/80 flex items-center justify-center gap-2", children: [
      "Made with ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-5 h-5 text-primary animate-pulse", fill: "currentColor" }),
      " by your favorite person ❤️"
    ] }),
...
function FinalSurpriseMoment() {
  const [showProposal, setShowProposal] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center px-4 md:px-8 py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 backdrop-blur-sm" }),
    showFireworks && /* @__PURE__ */ jsxRuntimeExports.jsx(FireworksAnimation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl w-full", children: [
      showProposal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-slow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-8 md:p-12 text-center glow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-20 h-20 mx-auto mb-8 text-primary animate-pulse", fill: "currentColor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl lg:text-6xl font-bold mb-12 text-gradient-romantic", children: "Will you be my forever Valentine?" }),
      ...
      showFinalMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-slow space-y-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-8 md:p-12 text-center glow-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gradient-gold leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-16 h-16 mx-auto text-primary", fill: "currentColor" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ValentinesCountdown, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingLoveFooter, {})
      ] })
    ] })
  ] });
}
...
function SecretCodeUnlock() {
  ...
  const handleSubmit = (e) => {
    ...
    if (normalizedCode === normalizedDate || normalizedCode === normalizedDate.slice(4) || normalizedCode === normalizedDate.slice(5) || normalizedCode === normalizedDate.slice(4) + normalizedDate.slice(0, 4)) {
      setIsUnlocked(true);
    } else {
      setShowHint(true);
      setTimeout(() => setShowHint(false), 3e3);
    }
  };
  if (isUnlocked) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: "💍" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl font-bold text-gradient-gold", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-2", children: "One More Secret..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Enter our special date to unlock the final message" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "secret-code", children: "Secret Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "secret-code",
      ...
      showHint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive text-center fade-in", children: "Hmm, that's not quite right. Try our anniversary date 💕" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "w-full", children: "Unlock" })
    ] })
  ] });
}
function SecretHeartEasterEgg() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showSecret, onOpenChange: setShowSecret, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "glass-card-strong border-primary/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-2xl md:text-3xl text-gradient-romantic text-center", children: "Secret Message Unlocked 💕" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-center font-medium", children: "You're the best thing that ever happened to me." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-6 border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SecretCodeUnlock, {}) })
      ] })
    ] }) })
  ] });
}
...
function SheetHeader({ className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-slot": "sheet-header", className: cn("flex flex-col gap-1.5 p-4", className), ...props });
}
...
function ScrollArea({ className, children, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Root$1, { "data-slot": "scroll-area", className: cn("relative", className), ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Viewport,
      {
...
function useCanisterUserSettings() {
...
function CanisterSyncControls() {
  const { login, loginStatus } = useInternetIdentity();
  const { isSaving, isLoading } = useCanisterUserSettings();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Login with Internet Identity to save your customizations to the cloud." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        onClick: handleLogin,
    ...
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center text-primary fade-in", children: message })
  ] });
}
function CustomizePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: isOpen, onOpenChange: setIsOpen, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "w-full sm:max-w-md glass-card-strong border-r-primary/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-2xl text-gradient-romantic", children: "Customize Your Love Story" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[calc(100vh-8rem)] mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pr-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: "Personal Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "her-name", children: "Her Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "her-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "your-name", children: "Your Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "your-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "anniversary", children: "Anniversary Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "anniversary",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: "Background Music" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ref: musicInputRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              onClick: () => {
                var _a2;
                return (_a2 = musicInputRef.current) == null ? void 0 : _a2.click();
              },
              variant: "outline",
              className: "w-full",
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: "12 Reasons Messages" }),
          flipCardMessages && flipCardMessages.slice(0, 11).map((entry, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: `message-${index2}`, children: [
              "Reason ",
              index2 + 1
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: `message-${index2}`,
                value: entry.message,
                onChange: (e) => setFlipCardMessage(index2, e.target.value),
                rows: 2,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: "Save to Cloud" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CanisterSyncControls, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
...
function AppContent() {
  ...
  const [audioStarted, setAudioStarted] = reactExports.useState(false);
  const handleStart = () => {
    setHasStarted(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AudioController, { shouldStart: audioStarted }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SecretHeartEasterEgg, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CustomizePanel, {}),
    !hasStarted ? /* @__PURE__ */ jsxRuntimeExports.jsx(LandingScreen, { onStart: handleStart }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OurStoryTimeline, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ReasonsFlipCards, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoveLetter, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoveMeter, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FinalSurpriseMoment, {})
    ] })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "light", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) }) });
}
